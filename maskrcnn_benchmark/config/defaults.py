...
# Values to be used for image normalization->caff2要求对255像数值进行标准化
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FPN = CN()
_C.MODEL.FPN.USE_GN = False#对通道进行分组求normalization
...
_C.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES = 17#17层
...
_C.SOLVER.WARMUP_ITERS = 500#预热训练
